...
enum class menuOption : int 
{
	...
	MENU_OPTION_CPU_INFINITE = 15, //Page 2, Tab 2 - Infinite CPU VS Player
	MENU_OPTION_CPU_TIMED = 20, //Page 2, Tab 2 - Timed CPU VS Player
	MENU_OPTION_CPU_SCORE = 25 //Page 2, Tab 2 - First to 5 CPU VS Player
};
